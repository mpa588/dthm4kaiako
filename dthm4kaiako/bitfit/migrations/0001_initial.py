    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bitfit.QuestionTypeFunction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('testcase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='bitfit.TestCase')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bitfit.QuestionTypeProgram')),
            ],
            options={
